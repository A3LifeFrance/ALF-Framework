...
_o addMagazineCargoGlobal ["ALF_saphir_small",1];
waitUntil {uiSleep 0.3; !isNull _o && {(count (magazineCargo _o)) > 0}};
["ALF_saphir_small",false] remoteExec ["life_fnc_handleItem",_unit];
...
_o2 addMagazineCargoGlobal ["ALF_saphir_taille",1];
