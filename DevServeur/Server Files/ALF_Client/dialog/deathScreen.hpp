class DeathScreen {
	...
	class Controls {
		...
		class RespawnBtn: Life_RscButtonMenu {
			...
			h = (1 / 25);
			text = "RESPAWN";
			onButtonClick = " if !(isNull attachedTo player) exitWith {}; closeDialog 0; life_respawned = true; [] call life_fnc_spawnMenu; [name player,getPlayerUID player,""MORT"",""A appuyé sur le bouton respawn""] remoteExec [""HC_fnc_logIt"",HC_Life];";
