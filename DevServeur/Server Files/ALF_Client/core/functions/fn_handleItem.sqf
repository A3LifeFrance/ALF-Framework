						...
						if(_ispack) then {
							...
							if(_ongun) then {
								...
								if(_override) then {
									...
									_wepItems = switch(_type) do {case 1:{RIFLE_ITEMS}; case 2:{secondaryWeaponItems player}; case 3:{handgunItems player}; default {["","",""]};};
									_slotTaken = false;
						...
						switch(true) do {
							case (_this in (uniformItems player)): {
								...
								clearWeaponCargoGlobal (uniformContainer player);
								{
									...
									(uniformContainer player) addWeaponCargoGlobal [ _x,_numVestWeps];
								}forEach _tWeapons;
							};
							...
							case (_this in (vestItems player)): {
								...
								clearWeaponCargoGlobal (vestContainer player);
								{
									...
									(vestContainer player) addWeaponCargoGlobal [ _x,_numVestWeps];
								}forEach _tWeapons;
							};
							...
							case (_this in (backpackItems player)): {
								...
								clearWeaponCargoGlobal (backpackContainer player);
								{
									...
									(backpackContainer player) addWeaponCargoGlobal [ _x,_numVestWeps];
								}forEach _tWeapons;
							};
						};
					};
