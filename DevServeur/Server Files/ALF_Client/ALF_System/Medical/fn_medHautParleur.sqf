...
switch (_mode) do {
	...
	case 0: {
		...
		_ctrlParlerCour buttonSetAction "[1] call ALF_fnc_medHautParleur;";
	...
	case 1: {
		...
		_ctrlParlerCour buttonSetAction "[2] call ALF_fnc_medHautParleur;";
	...
	case 2: {
		...
		format["TANGENT_LR	RELEASED	%1%2	%3	%4", 1617, "_bluefor", 10000 * (call TFAR_fnc_getTransmittingDistanceMultiplicator), "airborne"]] call TFAR_fnc_ProcessTangent;
