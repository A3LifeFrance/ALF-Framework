...
switch (_mode) do {
	case 0 : {
		...
		private _3dobj = createSimpleObject ["ALF_Objects\ALF_Roue\ALF_Roue.p3d",[0,0,0]];
	...
	case 2 : {
		...
		private _3dobj = createSimpleObject ["ALF_Objects\ALF_KitMecatechnic\MetalCase_01_small_F.p3d",[0,0,0]];
		_3dobj attachto [player,[-0.02,0,0], "RightHandMiddle1"];
		_3dobj setDir 0;
		_3dobj setVectorDirAndUp [[0,0,0],[0,0,0]];
		_3dobj setpos (getpos _3dobj);
		...
		if(!local _veh) then {
			[_veh,"HitGlass1",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitGlass2",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitGlass3",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitGlass4",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitFuel",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitGear",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitLight",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitBody",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
			[_veh,"HitHull",0] remoteExecCall ["ALF_fnc_setHPD",_veh];
		} else {
