...
//CAR
private _EngineCarVert = _display displayCtrl 30201;
private _EngineCarOrange = _display displayCtrl 30202;
private _EngineCarRouge = _display displayCtrl 30203;
...
private _MainCarVert = _display displayCtrl 30216;
private _MainCarOrange = _display displayCtrl 30217;
private _MainCarRouge = _display displayCtrl 30218;
...
switch (true) do {
	...
	case (_engineDamage > 0.33 && {_engineDamage < 0.66}) : {
		...
		_EngineMotoOrange ctrlShow true;
		_EngineMotoRouge ctrlShow false;
	};
	case (_engineDamage >= 0.66) : {
		_EngineMotoVert ctrlShow false;
		_EngineMotoOrange ctrlShow false;
		_EngineMotoRouge ctrlShow true;
	};
};
