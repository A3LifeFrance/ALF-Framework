...
["Caisse nationale.",format["%1 a retiré %2€ de la caisse nationale des Pompiers.",_name,[_num] call life_fnc_numberText]] remoteExecCall ["HC_fnc_doMedCall",HC_Life];

[_uid,_name,_num] remoteExec ["HC_fnc_retirerCNP",HC_life];
