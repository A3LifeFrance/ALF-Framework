...
/*
	File: fn_poserPiege.sqf
	Author: ALF Team
*/
private _coffre = _this select 0;
if(isNull _coffre) exitWith {};
if((_coffre animationSourcePhase 'piege_source') < 0.5) exitWith {};
...
["ALF_LockerC4_Artisanal",false] call life_fnc_handleItem;
[_coffre,2] remoteExec ["HC_fnc_customCoffre",HC_Life];
