...
_menuNMnum ctrlSetStructuredText parseText format["<t align='left' shadow='0' color='#000000' font='HelveticaNeueLTStdLt' size='1'>%1</t>", _cible select 0];
_menuNMbtnenvoyer buttonSetAction "[pInActNumber] spawn ALF_fnc_iPhoneSmsContactSend;";
_menuNMbtnannuler buttonSetAction "uiNamespace setVariable ['iphonemenu',4]; [] call ALF_fnc_menuiPhone;";
