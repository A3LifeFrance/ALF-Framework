...
if(EQUAL((lbCurSel 682567),-1)) exitWith {hint "Il faut selectionner quelqu'un."};
...
_menuNMbtnenvoyer buttonSetAction "[ALF_pInact_Number] spawn ALF_fnc_iPhoneSmsContactSend;";
_menuNMbtnannuler buttonSetAction "uiNamespace setVariable ['iphonemenu',9]; [] call ALF_fnc_menuiPhone;";
