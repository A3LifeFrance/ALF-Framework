...
if(_freq isEqualTo 30) then {
	...
	ALF_Sony_FreqAdd = 30;
	player setVariable ["SonyFreqAdd",30,([HC3_Life] + (((missionNamespace getVariable ["ALF_AllGendarmes",[]])) apply {_x getVariable ["ALF_ownerID",HC3_Life]}))];
	...
	ALF_Sony_Freq = _freq;
	player setVariable ["SonyFreq",_freq,([HC3_Life] + (((missionNamespace getVariable ["ALF_AllGendarmes",[]])) apply {_x getVariable ["ALF_ownerID",HC3_Life]}))];
};
