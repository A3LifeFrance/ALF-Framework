...
Author: ALF Team
*/
private _codeadn = ctrlText 13501;
if(_codeadn isEqualTo "") exitWith {["INFO","Le code faciès est vide.","warning"] spawn ALF_fnc_doMsg;};
...
[_codeadn,player] remoteExec ["HC_fnc_faceRecherche",HC_Life];
