...
Author: ALF Team
*/
private _codeadn = ctrlText 12503;
private _motif = ctrlText 12504;
...
private _action = ["Es-tu sûr de vouloir creer ce dossier, s'il existe dejà, le motif sera ecrase et mit à jour.","ADN","OUI","NON"] call BIS_fnc_guiMessage;
if (!_action) exitWith {};

[_codeadn,_motif,player] remoteExec ["HC_fnc_adncreate",HC_Life];
closeDialog 0;
