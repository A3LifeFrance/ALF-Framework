...
if !(license_gun) exitWith {["INFO", "Tu n'as pas la licence.", "warning"] spawn ALF_fnc_doMsg;};
...
[name player,getPlayerUID player,"INTERNET",format["A acheté %1€ sur internet (Armurerie).",_pricett]] remoteExec ["HC_fnc_logIt",HC3_Life];
