// config.bin - 23:51:34 07/07/18, generated in 0.05 seconds
...
class CfgVehicles {
	class WeaponHolder_Single_limited_item_F;	// External class reference
...
class CfgMagazines {
	...
	class murshun_cigs_lighter : CA_Magazine {
		...
		scope = public;
		displayName = "$STR_murshun_cigs_lighter";
		descriptionShort = "Peut allumer jusqu'à 100 cigarettes";
	...
	class murshun_cigs_cigpack : CA_Magazine {
		author = "$STR_murshun_cigs_author";
		scope = public;
		displayName = "Paquet de cigarettes";
		descriptionShort = "Contient 20 cigarettes. Fumer tue";
...
class CfgWeapons
{
    ...
    class murshun_cigs_cig0: NVGoggles
    {
        author = "$STR_murshun_cigs_author";
        displayName = "Cigarette";
        model = "\murshun_cigs\cig0.p3d";
        picture = "\murshun_cigs\UI\gear_cig0_x_ca";
        descriptionUse = "$STR_murshun_cigs_cigarette0";
        visionMode[] = {"Normal"};
        descriptionShort = "$STR_murshun_cigs_cigarette0";
	...
	class immersion_cigs_cigar0 : NVGoggles {
		author = "$STR_murshun_cigs_author";
		mass = 0.1;
		displayName = "Cigare";
		visionMode[] = {"Normal"};
...
class CfgMovesMaleSdr : CfgMovesBasic {
	...
	class States {
		...
		class CutSceneAnimationBase;	// External class reference
		
		class ALF_CIGS_SMOKING : CutSceneAnimationBase {
			file = "\murshun_cigs\anims\ALF_CIGS_SMOKING";
			speed = 0.049767;
			boundingSphere = 4;
