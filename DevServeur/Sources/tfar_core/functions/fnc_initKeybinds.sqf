...
["TFAR","Radio Aérienne",["Radio Aérienne","Touche pour parler sur la radio aérienne."],{call ALF_fnc_onAirRadioPressed},{call ALF_fnc_onAirRadioReleased},[34, TF_tangent_lr_modifiers],false] call cba_fnc_addKeybind;

["TFAR","Megaphone",["Megaphone Gendarmerie","Touche pour parler dans un megaphone"],{[] call ALF_fnc_onMegaphonePressed},{[] call ALF_fnc_onMegaphoneReleased},[16, TF_tangent_sw_modifiers],false] call cba_fnc_addKeybind;
